...
local rec_ls
rec_ls = function()
	return sn(nil, { c(1, { t({ "" }), sn(nil, { t(" << "), i(1), d(2, rec_ls, {}) }) }) })
end

ls.add_snippets("cpp", {
	s("cp", { t("// Copyright 2023 Open Ocean Robotics"), i(0) }),
	s("fn", {
		i(1, "rtype"),
		t(" "),
		i(2, "foo"),
...
ls.add_snippets("all", { s("autotrigger", { t("autosnippet") }) }, { type = "autosnippets", key = "all_auto" })
